    ...
    <form class="form-horizontal" id = "form2" role="form" method="POST" action="{{ url('/auth/register') }}">
        ...
        <div class="form-group col-md-12 form">
            ...
            <div class="col-md-10 col-md-offset-1">
                <input class = "inp" type="text" name="name" value="my company name">
            </div>
        </div>
        ...
        <div class="form-group col-md-12 form">
            ...
            <div class="col-md-10 col-md-offset-1">
                <input class = "inp" type="password" name="password" value=" Your name">
            </div>
        </div>
        ...
        <div class="form-group col-md-12 form">
            ...
            <div class="col-md-10 col-md-offset-1">
                <input class = "inp" type="password" name="password_confirmation" value="Please confirm your password">
            </div>
        </div>
